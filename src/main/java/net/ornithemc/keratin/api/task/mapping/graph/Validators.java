...
public class Validators {
	...
	public static final MappingValidator removeDummyMappings(boolean fullClassNames) {
	...
	public static final MappingsDiffValidator insertDummyMappings() {
		return new MappingsDiffValidator() {
